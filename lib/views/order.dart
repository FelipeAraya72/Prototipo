...
class OrderPage extends StatefulWidget {
  const OrderPage({Key? key, required this.peso, this.initialQuantity = 0})
      : super(key: key);
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton(
                            onPressed: () => setState(() =>
                                quantity = (quantity! - 1).clamp(0, 2000000)),
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => Navigator.of(context).push(
                            MaterialPageRoute(
                                builder: (__) => CartPage(items: [
                                      ItemResult("Restos de tablones",
                                          quantity!, widget.peso * quantity!)
                                    ]))),
                        child: Container(
                          child: Column(
                            children: [
