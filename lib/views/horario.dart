          ...
          child: Container(
            child: Column(
              children: [
                ...
                HorarioButton(
                  text: "Lunes 9am-10am. 11 de Octubre",
                  onPressed: () => setIdPressed(0),
                  backgroundColor: idPressed != null && idPressed == 0
                      ? Colors.black12
                      : Colors.white,
                  textColor: Colors.black,
                ),
                HorarioButton(
                  text: "Martes 10am-11am. 12 de Octubre",
                  onPressed: () => setIdPressed(1),
                  backgroundColor: idPressed != null && idPressed == 1
                      ? Colors.black12
                      : Colors.white,
                  textColor: Colors.black,
                ),
                HorarioButton(
                  text: "Miercoles 11am-12am. 13 de Octubre",
                  onPressed: () => setIdPressed(2),
                  backgroundColor: idPressed != null && idPressed == 2
                      ? Colors.black12
                      : Colors.white,
                  textColor: Colors.black,
                ),
                HorarioButton(
                  text: "Jueves 13pm-14pm. 14 de Octubre",
                  onPressed: () => setIdPressed(3),
                  backgroundColor: idPressed != null && idPressed == 3
                      ? Colors.black12
                      : Colors.white,
                  textColor: Colors.black,
                ),
                    ...
                    onPressed: () async {
                      ...
                      Future.delayed(
                          ...
                          () => Navigator.of(context).push(
                              MaterialPageRoute(builder: (__) => RatePage())));
                    },
