...
class _RatePageState extends State<RatePage> {
  ...
  void setRecycled(bool like) {
    ...
    ScaffoldMessenger.of(context)
        .showSnackBar(SnackBar(content: Text("Voto recibido!")));
    //toBack();
  }
