        ...
        child: Card(
          child: Container(
            ...
            child: Row(
              children: [
                Image(
                  image: AssetImage("assets/madera2.png"),
                ),
                Expanded(
                  child: Column(
                    children: [
              ...
              children: [
                ...
                TextButton(
                    ...
                    onPressed: () => Navigator.of(context)
                        .push(MaterialPageRoute(builder: (__) => MapaPage())),
                ...
                Row(
                  ...
                  children: [
                    Text("Total: "),
                    Text(
                        "${items.fold<int>(0, (previousValue, element) => previousValue += element.peso)} KG")
                  ],
                ),
                TextButton(
                    style: TextButton.styleFrom(
                    ...
                    onPressed: () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (__) => HorarioPage())),
                    child: Text("Seleccionar horario de retiro")),
              ],
            ),
          ),
        ),
