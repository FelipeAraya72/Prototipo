...
class HomePage extends StatelessWidget {
  ...
  final Map<String, ItemResult?> results = {"madera": ItemResult("", 0, 0)};
    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.more_outlined), label: 'Más'),
        ],
      ),
      body: SafeArea(
            ...
            child: Column(
              children: [
                ...
                Row(
                    ...
                    children: [
                      CategoryButton(
                          text: "Madera", assetImageUrl: "assets/madera2.png"),
                    ]),
                SizedBox(
                  height: 30,
                ),
                ...
                TextButton(
                  onPressed: () async {
                    var result = await Navigator.of(context).push(
                        MaterialPageRoute(
                            builder: (__) => OrderPage(
                                peso: peso,
                                initialQuantity: results["madera"]!.quantity)));
                    try {
                      if (result != null) {
